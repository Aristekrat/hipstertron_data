...
class GothicTestCase(unittest.TestCase):
	...
	def test_dates_format_month_length(self):
		self.assertEqual(len(gothic_trace.artists_stripped_chars), len(gothic_trace.dates_format_month))
	...
	def test_ticket_links_raw_length(self):
		self.assertEqual(len(gothic_trace.artists_stripped_chars), len(gothic_trace.ticket_links_raw))

	def test_ticket_links_raw_length(self):
		self.assertEqual(len(gothic_trace.artists_stripped_chars), len(gothic_trace.ticket_links))

	def test_ticket_links_raw_length(self):
		self.assertEqual(len(gothic_trace.artists_stripped_chars), len(gothic_trace.ticket_prices_without_fees))

	def test_ticket_links_raw_length(self):
		self.assertEqual(len(gothic_trace.artists_stripped_chars), len(gothic_trace.ticket_prices_patched))

	def test_final_list_length(self):
		self.assertEqual(len(gothic_trace.ticket_prices), len(gothic_trace.dates_datetime), len(gothic_trace.ticket_links))
