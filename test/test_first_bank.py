...
class FirstBankTestCase(unittest.TestCase):
	...
	def test_dates_format_month_length(self):
		self.assertEqual(len(first_bank_trace.artists_stripped_chars), len(first_bank_trace.dates_format_month))
	...
	def test_ticket_links_raw_length(self):
		self.assertEqual(len(first_bank_trace.artists_stripped_chars), len(first_bank_trace.ticket_links_raw))

	def test_ticket_links_raw_length(self):
		self.assertEqual(len(first_bank_trace.artists_stripped_chars), len(first_bank_trace.ticket_links))

	def test_ticket_links_raw_length(self):
		self.assertEqual(len(first_bank_trace.artists_stripped_chars), len(first_bank_trace.ticket_prices_without_fees))

	def test_ticket_links_raw_length(self):
		self.assertEqual(len(first_bank_trace.artists_stripped_chars), len(first_bank_trace.ticket_prices_patched))

	def test_final_list_length(self):
		self.assertEqual(len(first_bank_trace.ticket_prices), len(first_bank_trace.dates_datetime), len(first_bank_trace.ticket_links))
